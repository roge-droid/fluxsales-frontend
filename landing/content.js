...
window.COPY = {
  es: {
    ...
    pricing: {
      eyebrow: "Precios",
      title: "Dos planes. La misma plataforma completa.",
      subtitle: "Tú solo eliges cómo pagar: una pequeña comisión por orden, o costo fijo sin comisiones. Mes a mes, sin contratos anuales.",
      perMonth: "/mes",
      plans: [
        {
          name: "Flexible",
          tag: "Mensualidad más baja con una pequeña comisión por orden. Tus costos suben solo cuando tus ventas suben.",
          price: 3499,
          ...
          badge: "Más popular",
          features: [
            "La plataforma completa: web, pedidos en línea y app con tu marca",
            "Pago por uso: solo pagas más cuando vendes más",
        ...
        {
          name: "Sin comisiones",
          tag: "Costo predecible, cero comisiones por orden. Mejor si ya facturas $70,000+/mes en órdenes en línea.",
          price: 6999,
          fee: "Sin comisiones por orden",
          taxes: "+ IVA",
          cta: "Agenda una demo",
          features: [
            "La misma plataforma completa, sin comisión por orden",
            "Costo fijo y predecible al escalar",
            "Arriba de $70,000/mes en órdenes, pagas menos que en Flexible",
            "Migración y soporte 24/7 incluidos",
          ],
        },
      ],
      addonsTitle: "Agrega a cualquier plan",
      addons: [
        {
          name: "Flotilla de entregas",
          price: 1499,
          desc: "Repartidores on-demand con un clic — entregas en 30 min, $0 comisión de entrega, dispatch y tracking en vivo.",
        },
        {
          name: "Mesero IA",
          price: 1999,
          desc: "Toma pedidos por WhatsApp 24/7, sin una persona. Incluye onboarding prioritario y success manager dedicado.",
        },
      ],
      multiNote: "Tarifas especiales disponibles para multi-sucursal",
      valueAnchor: "Una orden de $350 en una app de delivery te cuesta ~$105 de comisión. Con FluxSales, máximo $17.50 — o $0 en el plan Sin comisiones.",
      guarantee: {
      ...
      includedTitle: "La plataforma completa — incluida en ambos planes",
      included: [
  ...
  en: {
    ...
    pricing: {
      eyebrow: "Pricing",
      title: "Two plans. The same full platform.",
      subtitle: "You just choose how to pay: a small per-order fee, or a flat rate with no commissions. Month-to-month, no annual contracts.",
      perMonth: "/mo",
      plans: [
        {
          name: "Flexible",
          tag: "Lower monthly cost with a small per-order fee. Your costs scale with your sales.",
          price: 3499,
          fee: "+ 5% fee per order",
          taxes: "+ VAT",
          cta: "Book a demo",
          ...
          badge: "Most popular",
          features: [
            "The full platform: website, online ordering and branded app",
            "Pay-as-you-grow: you only pay more when you sell more",
        ...
        {
          name: "Flat rate",
          tag: "Predictable cost and no per-order fees. Best for restaurants at $70,000+ MXN/mo in online sales.",
          price: 6999,
          fee: "No per-order fees",
          taxes: "+ VAT",
          cta: "Book a demo",
          features: [
            "The same full platform, with no per-order fee",
            "Fixed, predictable cost as you scale",
            "Above $70,000 MXN/mo in orders, you pay less than on Flexible",
            "Migration and 24/7 support included",
          ],
        },
      ],
      addonsTitle: "Add to either plan",
      addons: [
        {
          name: "Flotilla delivery",
          price: 1499,
          desc: "On-demand drivers in one click — 30-min deliveries, $0 delivery commission, one-click dispatch and live tracking.",
        },
        {
          name: "Mesero AI",
          price: 1999,
          desc: "Takes WhatsApp orders 24/7, no human needed. Includes priority onboarding and a dedicated success manager.",
        },
      ],
      multiNote: "Special rates available for multi-location",
      valueAnchor: "A $350 order on a delivery app costs you ~$105 in commission. With FluxSales it's $17.50 max — or $0 on the Flat rate plan.",
      guarantee: {
      ...
      includedTitle: "The full platform — included on both plans",
      included: [
